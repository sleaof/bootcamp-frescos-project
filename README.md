...
Autentique-se como BUYER/SELLER
Exemplo: http://localhost:8082/api/v1/sign-in?username=BUYER&password=contra123
...
####GET, http://localhost:8082/fresh-products/list/warehouse
